...
function footerHTML() {
    ...
    html += '<img src="https://png.pngtree.com/png-vector/20220704/ourmid/pngtree-wave-blue-logo-template-png-image_5565593.png" alt="Logo">';
    html += '</div>';
    
    html += '<div class="flex flexCol" id="copyright">';
    html += 'Copyright © ' + new Date().getFullYear() + ' Ocean Supermart Services<br>';
    ...
    html += '<a href="https://github.com/Green-Supermart" target="_blank">GitHub</a> <i class="fa-solid bg-blue fa-square-arrow-up-right"></i>';
    html += '</span>';
    html += '<span class="externLinks">';
    html += '<a href="https://www.instagram.com" target="_blank">Instagram</a> <i class="fa-solid bg-blue fa-square-arrow-up-right"></i>';
    html += '</span>';
    html += '</div>';
    html += '</div>';
